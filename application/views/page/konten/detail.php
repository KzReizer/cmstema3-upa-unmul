...
?><div role="main" class="main">
    ...
    <section class="cms-page-banner cms-page-banner--detail">
        <div class="cms-page-banner-overlay"></div>
        <div class="container cms-page-banner-content">
            <ul class="breadcrumb">
                
            </ul>
            <h1><?= htmlspecialchars($datas != false ? $datas->{'kontenJudul'.$lang} : '', ENT_QUOTES, 'UTF-8') ?></h1>
        </div>
    </section>

    <div class="container cms-content-page cms-content-page--detail">
        <div class="row">
            <div class="col-12">
